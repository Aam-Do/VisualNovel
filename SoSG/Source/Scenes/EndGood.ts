namespace SakuraGlade {
    export async function GoodEnding(): ƒS.SceneReturn {
        ...
        await ƒS.Character.show(characters.kohana, characters.kohana.pose.neutral, ƒS.positionPercent(62, 100));
        await ƒS.Character.show(characters.nobu, characters.nobu.pose.neutral, ƒS.positionPercent(80, 100));
        await ƒS.update(1);
        ...
        await ƒS.Character.hide(characters.kohana);
        await ƒS.Character.hide(characters.nobu);
        await ƒS.Character.show(characters.fumiko, characters.fumiko.pose.neutral, ƒS.positionPercent(80, 100));
        await ƒS.update(1);
