...
(function (SakuraGlade) {
    async function FairieForest() {
        ...
        await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.surprised, SakuraGlade.ƒS.positionPercent(50, 100));
        await SakuraGlade.ƒS.update(1);
        ...
        switch (choice1Element) {
            case choice1.neutral:
                ...
                await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.sad, SakuraGlade.ƒS.positionPercent(50, 100));
                await SakuraGlade.ƒS.update(1);
                await SakuraGlade.ƒS.Speech.tell("???", "Ahem... now that's not a very kind thing to say...");
                SakuraGlade.ƒS.Speech.setTickerDelays(40, 5000);
                await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.neutral, SakuraGlade.ƒS.positionPercent(50, 100));
                await SakuraGlade.ƒS.update(1);
                await SakuraGlade.ƒS.Speech.tell("???", "I'm a Capfolk. We live here in the Forest of Fairie.");
                await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.thinking, SakuraGlade.ƒS.positionPercent(50, 100));
                await SakuraGlade.ƒS.update(1);
            ...
            case choice1.good:
                ...
                await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.laughing, SakuraGlade.ƒS.positionPercent(50, 100));
                await SakuraGlade.ƒS.update(1);
                await SakuraGlade.ƒS.Speech.tell("???", "Ohohoh!");
                await await SakuraGlade.ƒS.Character.show(SakuraGlade.characters.nobu, SakuraGlade.characters.nobu.pose.smiling, SakuraGlade.ƒS.positionPercent(50, 100));
                await SakuraGlade.ƒS.update(1);
